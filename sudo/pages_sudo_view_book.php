                    ...
                    <div class="uk-width-large-10-10">
                        ...
                        <div class="md-card">
                            ...
                            <div class="user_content">
                                            ...
                                            <h4 class="heading_c uk-margin-small-bottom"></h4>
                                                ...
                                                <ul class="md-list md-list-addon">
                                                    <li>
                                                        ...
                                                        <div class="md-list-content">
                                                            <span class="md-list-heading"><?php echo $row->b_copies_path;?></span>
                                                            <span class="uk-text-small uk-text-muted">Path to File</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="md-list-addon-element">
                                ...
                                <div class="md-card md-card-hover">
                                        <div class="gallery_grid_item md-card-content">
                                        <object width="100%" height="500" type="application/pdf" data="https://hillary-mccloud.000webhostapp.com/sudo/<?php echo $row->b_copies_path; ?>#zoom=85&scrollbar=0&toolbar=1&navpanes=1"></object>
                                        </div>
                                    </div>
                                </div>
                            </div>
