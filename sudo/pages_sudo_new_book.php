...
if (isset($_POST['add_book'])) {
    ...
    if (!$error) {
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            $targetfolder1 = "testupload/";

            $targetfolder = $targetfolder1 . basename($_FILES['b_publisher_file']['name']);

            $ok = 1;

            $file_type = $_FILES['b_publisher_file']['type'];

            if ($file_type == "application/pdf") {

                if (move_uploaded_file($_FILES['b_publisher_file']['tmp_name'], $targetfolder)) {

                    // echo "The file " . basename($_FILES['b_publisher_file']['name']) . " is uploaded to >: ".$targetfolder;
                    ...
                    $query="INSERT INTO iL_Books (b_title, b_copies_path, b_author, 
                    b_isbn_no, b_publisher, bc_id, bc_name, b_status, b_summary,
                    b_coverimage) VALUES (?,?,?,?,?,?,?,?,?,?)";
                    $stmt = $mysqli->prepare($query);
                    //bind paramaters
                    $rc=$stmt->bind_param('ssssssssss', $b_title, $b_copies_path, 
                    $b_author, $b_isbn_no, $b_publisher, $bc_id, $bc_name, $b_status, 
                    $b_summary, $b_coverimage);
                    $stmt->execute();
                    ...
                    $err =  "Problem uploading file";

                }

            } else {

                $err =  "You may only upload PDF files.<br>";
                        ...
                        <div class="uk-grid" data-uk-grid-margin>
                            <div class="uk-width-medium-1-2">
                                ...
                                <div class="uk-form-row">
                                    ...
                                    <input type="text" required value="ISBN 0-13-<?php echo $Number; ?>-1"
                                        name="b_isbn_no" class="md-input label-fixed" />
                                </div>
                                <div class="uk-form-row">
                                ...
                                <div class="uk-form-row">
                                    <label>Browse PDF file</label> <br>
                                    <input type="file" required name="b_publisher_file" class="md-input" />
                                </div>
                            ...
                            <div class="uk-width-medium-1-2">
                                ...
                                <div class="uk-form-row">
                                    ...
                                    <select required onChange="getBookId(this.value);" name="bc_name"
                                        class="md-input" />
                            ...
                            <div class="uk-width-medium-2-2">
                                <div class="uk-form-row">
                                    <div class="uk-input-group">
                                        <input type="submit" class="md-btn md-btn-success" name="add_book"
                                            value="Add Book" />
                                    </div>
                                </div>
                            </div>
