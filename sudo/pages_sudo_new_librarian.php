    ...
    if(isset($_POST['add_librarian']))
    {
        $error = 0;
            if (isset($_POST['l_name']) && !empty($_POST['l_name'])) {
                ...
                $error = 1;
                $err="Announcement cannot be empty";
            }
            ...
            { 
                ...
                $query="INSERT INTO il_announcements (details) VALUES (?)";
                $stmt = $mysqli->prepare($query);
                //bind paramaters
                $rc=$stmt->bind_param('s', $l_name);
                $stmt->execute();
                            ...
                            <div class="uk-width-medium-2-2">
                                <div class="uk-form-row">
                                    <div class="uk-input-group">
                                        <input type="submit" class="md-btn md-btn-success" name="add_librarian" value="Create Latest Announcement" />
                                    </div>
                                </div>
                            </div>
                        </div>
