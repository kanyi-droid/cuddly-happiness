    ...
    <div id="page_content">
        ...
        <div id="top_bar">
            <ul id="breadcrumbs">
                ...
                <li><a href="#">JKUAT BOOK CLUB</a></li>
                <li><span>New Announcement</span></li>
            </ul>
            </ul>
        </div>
        <div id="page_content_inner">

            <h4 class="heading_a uk-margin-bottom">eLibrary Announcement</h4>
            <div class="md-card uk-margin-medium-bottom">
                <div class="md-card-content">
                    ...
                    <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php
                            $ret = "SELECT * FROM  il_announcements";
                            ...
                            while ($row = $res->fetch_object()) {
                                ...
                                //     $account_status = "<td class='uk-text-success'>$row->id</td>";
                                // } elseif ($row->l_acc_status == 'Pending') {
                                //     $account_status = "<td class='uk-text-warning'>$row->details</td>";
                                // } else {
                                //     $account_status = "<td class='uk-text-danger'>$row->created_at</td>";
                                // }
                                ?>
                                <tr>
                                    <td>
