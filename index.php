            ...
            <div class="container">
                <div class="row wow fadeInUp">
                    <div class="col-xs-12 col-sm-10 col-sm-offset-1 text-center">
                        <div class="jumbotron">
                            <h1 class="text-white"> JKUAT Bookclub eLibrary system</h1>
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#book"><b>Announcements</b></a></li>
                                </ul>
                            </div>
                            <div class="panel-body">
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="book">
                                        ...
                                        $ret = "SELECT * FROM `il_announcements` ORDER by id DESC LIMIT 1;";
                                        ...
                                        while ($row = $res->fetch_object()) {
                                            ...
                                            <ul class="list-unstyled menu-tip">
                                                ...
                                                <li>
                                                    <?php echo $row->details; ?> <a href="books.php">See More</a>
                                                </li>
                                            </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 text-center">
                    <h2><strong>Book Categories</strong></h2>
